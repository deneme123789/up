...
[Ekleme Linkim](https://discord.com/api/oauth2/authorize?client_id=877187865208041552&permissions=8&scope=bot)

[Destek Sunucum](https://discord.gg/rjmVRKUhBK)
...
» [${prefix}ekle](https://discord.gg/rjmVRKUhBK) Link Eklemenize Yarar
» [${prefix}erişim-kontrol](https://discord.gg/rjmVRKUhBK) Erişim Kontrol
» [${prefix}linkler](https://discord.gg/rjmVRKUhBK) Liklerinizi Gösterir
`)
  .addField('**Hakkında**',`
...
==================================
> » [Destek Server](https://discord.gg/rjmVRKUhBK)
> » [Eklemek İçin](https://discord.com/api/oauth2/authorize?client_id=877187865208041552&permissions=8&scope=bot)`)
...
client.on('ready', () => {
client.user.setActivity(`${prefix}yardım | Kanser Uptime🌐`, { type: 'WATCHING' })
